...
### [Click here to view an example of how to set up the computation for calculating the amount in the Purchase Order.](https://docs.rdrive.io/setup/company/categories/categories-template-setup-knowledge-base/computation/computation-best-practices-in-finance-accounting)
